            ...
            editingId === m.id ? (
              <div className="max-w-[65%]">
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-[14px] bg-white text-text-primary text-[14px] leading-relaxed border border-primary/30 focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none min-h-[80px]"
                  autoFocus
                  onKeyDown={(e) => {
