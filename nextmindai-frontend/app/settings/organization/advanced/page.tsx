...
export default function AdvancedPage() {
  return (
    <div className="animate-fade-in">
      ...
      <p className="text-[14px] text-text-secondary mb-8">Advanced organization settings.</p>
      ...
      <div className="space-y-6">
        <div className="bg-surface border border-border rounded-[12px] p-6">
          ...
          <p className="text-[13px] text-text-secondary mb-4">
            Export all your organization's data including conversations, documents, and settings.
          </p>
        ...
        <div className="bg-surface border border-red-500/20 rounded-[12px] p-6">
          ...
          <p className="text-[13px] text-text-secondary mb-4">
            Permanently delete your organization and all its data. This action cannot be undone.
          </p>
